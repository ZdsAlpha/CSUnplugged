...
$('body').append('' +
    '<div class="fixed-button">' + '<a href="https://codedthemes.com/item/datta-able-premium/" target="_blank" class="btn btn-md btn-primary">' + '<i class="fa fa-users" aria-hidden="true"></i> Go to Team Profile' +
    '</a> ' + '</div>' + '');
var $window = $(window);
